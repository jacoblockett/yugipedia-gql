# Set Printouts and GQL Keys

|GQL Key|Printout|Type|Description|
|-|-|-|-|
|`code.ean`|[EAN](https://yugipedia.com/wiki/Property:EAN)|`string`|The [EAN]() product code
|`code.isbn`|[ISBN](https://yugipedia.com/wiki/Property:ISBN)|`string`|The [ISBN]() product code
|`code.upc`|[UPC](https://yugipedia.com/wiki/Property:UPC)|`string`|The [UPC]() product code
|`coverCards`|[Cover card](https://yugipedia.com/wiki/Property:Cover_card)|`string[]`|The [cover cards](https://yugipedia.com/wiki/Cover_card) show on the packaging
|`format`|[Format](https://yugipedia.com/wiki/Property:Format)|`string`|The [format](https://yugipedia.com/wiki/Format) of [forbidden & limited list](https://yugipedia.com/wiki/Status) sets
|`image`|[Set image](https://yugipedia.com/wiki/Property:Set_image)|`string`|The image show on the main page of the set
|`konamiID.chinese.simplified`|[Simplified Chinese database ID](https://yugipedia.com/wiki/Property:Simplified_Chinese_database_ID)|`string`|The Chinese set ID Konami uses in [their database](https://db.yugioh-card-cn.com/)
|`konamiID.english.asian`|[Asian-English database ID](https://yugipedia.com/wiki/Property:Asian-English_database_ID)|`string`|The Asian-English ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.english.earliest`|[English database ID](https://yugipedia.com/wiki/Property:English_database_ID)|`string`|The English ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.french`|[French database ID](https://yugipedia.com/wiki/Property:French_database_ID)|`string`|The French ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.german`|[German database ID](https://yugipedia.com/wiki/Property:German_database_ID)|`string`|The German ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.italian`|[Italian database ID](https://yugipedia.com/wiki/Property:Italian_database_ID)|`string`|The Italian ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.japanese`|[Japanese database ID](https://yugipedia.com/wiki/Property:Japanese_database_ID)|`string`|The Japanese ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.korean`|[Korean database ID](https://yugipedia.com/wiki/Property:Korean_database_ID)|`string`|The Korean ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.portuguese`|[Portuguese database ID](https://yugipedia.com/wiki/Property:Portuguese_database_ID)|`string`|The Portuguese ID Konami uses in [their database](https://www.db.yugioh-card.com/)
|`konamiID.spanish`|[Spanish database ID](https://yugipedia.com/wiki/Property:Spanish_database_ID)|`string`|The Spanish ID Konami uses in [their database](https://www.db.yugioh-card.com/)
...
|`regionalPrefix.german`|[German set and region prefix](https://yugipedia.com/wiki/Property:German_set_and_region_prefix)|`string`|German set and region prefix
